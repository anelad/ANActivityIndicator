//
//  ANActivityIndicatorAnimationBallClipRotatePulse.swift
...
class ANActivityIndicatorAnimationBallClipRotatePulse: ANActivityIndicatorAnimation {
    required init() {
    ...
    func smallCircleWith(duration: CFTimeInterval, timingFunction: CAMediaTimingFunction, layer: CALayer, size: CGSize, color: UIColor) {
        ...
        let circle = ANActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
    ...
    func bigCircleWith(duration: CFTimeInterval, timingFunction: CAMediaTimingFunction, layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = ANActivityIndicatorShape.ringTwoHalfVertical.layerWith(size: size, color: color)
