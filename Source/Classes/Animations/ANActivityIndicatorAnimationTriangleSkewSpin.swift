//
//  ANActivityIndicatorAnimationTriangleSkewSpin.swift
...
class ANActivityIndicatorAnimationTriangleSkewSpin: ANActivityIndicatorAnimation {
    required init() {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw triangle
        let triangle = ANActivityIndicatorShape.triangle.layerWith(size: size, color: color)
