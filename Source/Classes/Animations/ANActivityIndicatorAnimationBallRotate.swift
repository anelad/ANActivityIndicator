//
//  ANActivityIndicatorAnimationBallRotate.swift
...
class ANActivityIndicatorAnimationBallRotate: ANActivityIndicatorAnimation {
    required init() {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        let leftCircle = ANActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        let rightCircle = ANActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        let centerCircle = ANActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
