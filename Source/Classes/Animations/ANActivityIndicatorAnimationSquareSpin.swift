//
//  ANActivityIndicatorAnimationSquareSpin.swift
...
class ANActivityIndicatorAnimationSquareSpin: ANActivityIndicatorAnimation {
    required init() {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw square
        let square = ANActivityIndicatorShape.rectangle.layerWith(size: size, color: color)
