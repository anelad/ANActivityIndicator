//
//  ANActivityIndicatorAnimationBallClipRotateMultiple.swift
...
class ANActivityIndicatorAnimationBallClipRotateMultiple: ANActivityIndicatorAnimation {
    required init() {
    ...
    func circleOf(shape: ANActivityIndicatorShape, duration: CFTimeInterval, timingFunction: CAMediaTimingFunction, layer: CALayer, size: CGFloat, color: UIColor, reverse: Bool) {
