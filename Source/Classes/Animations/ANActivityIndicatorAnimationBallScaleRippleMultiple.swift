//
//  ANActivityIndicatorAnimationBallScaleRippleMultiple.swift
...
class ANActivityIndicatorAnimationBallScaleRippleMultiple: ANActivityIndicatorAnimation {
    required init() {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        for i in 0 ..< 3 {
            let circle = ANActivityIndicatorShape.ring.layerWith(size: size, color: color)
