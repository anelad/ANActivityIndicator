//
//  ANActivityIndicatorAnimationBallTrianglePath.swift
...
class ANActivityIndicatorAnimationBallTrianglePath: ANActivityIndicatorAnimation {
    required init() {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Top-center circle
        let topCenterCircle = ANActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-left circle
        let bottomLeftCircle = ANActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-right circle
        let bottomRightCircle = ANActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
