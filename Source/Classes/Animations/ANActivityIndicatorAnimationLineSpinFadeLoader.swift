//
//  ANActivityIndicatorAnimationLineSpinFadeLoader.swift
...
class ANActivityIndicatorAnimationLineSpinFadeLoader: ANActivityIndicatorAnimation {
    required init() {
    ...
    func lineAt(angle: CGFloat, size: CGSize, origin: CGPoint, containerSize: CGSize, color: UIColor) -> CALayer {
        ...
        let line = ANActivityIndicatorShape.line.layerWith(size: size, color: color)
