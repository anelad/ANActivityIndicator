//
//  ANActivityIndicatorAnimationPacman.swift
...
class ANActivityIndicatorAnimationPacman: ANActivityIndicatorAnimation {
  required init() {
  ...
  func pacmanInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
    ...
    // Draw pacman
    let pacman = ANActivityIndicatorShape.pacman.layerWith(size: CGSize(width: pacmanSize, height: pacmanSize), color: color)
    let frame = CGRect(
