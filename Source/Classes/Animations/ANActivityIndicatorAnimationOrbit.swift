//
//  ANActivityIndicatorAnimationOrbit.swift
...
class ANActivityIndicatorAnimationOrbit: ANActivityIndicatorAnimation {
    required init() {
    ...
    func ring1InLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
      ...
      scaleAnimation.timingFunctions = [CAMediaTimingFunction(name: CAMediaTimingFunctionName.linear), timingFunction]
        ...
        // Draw circle
        let circle = ANActivityIndicatorShape.circle.layerWith(size: CGSize(width: coreSize, height: coreSize), color: color)
    ...
    func satelliteInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = ANActivityIndicatorShape.circle.layerWith(size: CGSize(width: satelliteSize, height: satelliteSize), color: color)
